...
from fine_tuning.instruction.Evaluation import check_if_running, query_model
...
def test_generate():
    global entry, generated_text, response_text
...
def generate_and_save_batch_response():
    global entry, generated_text, response_text
...
test_generate()
generate_and_save_batch_response()